;;; snaek-everblush-theme.el --- based on everblush colorscheme by Mangeshrex -*- lexical-binding: t; no-byte-compile: t; -*-
;;; Code:
...
(def-doom-theme snaek-everblush
...
;;   (variables      dark-blue)
  ...
  (((line-number &override) :foreground (doom-lighten base4 0.15))
   ...
   (hl-line :background "#1f2930")
   (treemacs-file-face :inherit 'hl-line)
...
;;; snaek-everblush-theme.el ends here
